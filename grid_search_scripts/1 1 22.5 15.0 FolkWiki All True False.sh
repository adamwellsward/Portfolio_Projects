...
do
    python search_states_filter_one_config.py --n-chords "1" --n-melody "1" --t-prior "22.5" --e-prior "15.0" --dataset "FolkWiki" --keys "All" --filter-train-set "True" --filter-val-set "False"
