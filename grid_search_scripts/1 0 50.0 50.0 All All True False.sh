...
do
    python search_states_filter_one_config.py --n-chords "1" --n-melody "0" --t-prior "50.0" --e-prior "50.0" --dataset "All" --keys "All" --filter-train-set "True" --filter-val-set "False"
