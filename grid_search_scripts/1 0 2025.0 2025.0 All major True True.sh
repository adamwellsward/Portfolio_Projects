...
do
    python search_states_filter_one_config.py --n-chords "1" --n-melody "0" --t-prior "2025.0" --e-prior "2025.0" --dataset "All" --keys "major" --filter-train-set "True" --filter-val-set "True"
