...
do
    python search_states_filter_one_config.py --n-chords "2" --n-melody "2" --t-prior "2.0" --e-prior "0.0" --dataset "All" --keys "phrygian" --filter-train-set "True" --filter-val-set "False"
