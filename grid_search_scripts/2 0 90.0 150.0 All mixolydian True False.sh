...
do
    python search_states_filter_one_config.py --n-chords "2" --n-melody "0" --t-prior "90.0" --e-prior "150.0" --dataset "All" --keys "mixolydian" --filter-train-set "True" --filter-val-set "False"
