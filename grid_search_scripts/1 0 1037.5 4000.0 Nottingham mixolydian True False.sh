...
do
    python search_states_filter_one_config.py --n-chords "1" --n-melody "0" --t-prior "1037.5" --e-prior "4000.0" --dataset "Nottingham" --keys "mixolydian" --filter-train-set "True" --filter-val-set "False"
