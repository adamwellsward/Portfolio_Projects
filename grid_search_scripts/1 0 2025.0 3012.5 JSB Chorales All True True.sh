...
do
    python search_states_filter_one_config.py --n-chords "1" --n-melody "0" --t-prior "2025.0" --e-prior "3012.5" --dataset "JSB Chorales" --keys "All" --filter-train-set "True" --filter-val-set "True"
