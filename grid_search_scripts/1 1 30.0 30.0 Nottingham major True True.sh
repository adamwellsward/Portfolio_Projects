...
do
    python search_states_filter_one_config.py --n-chords "1" --n-melody "1" --t-prior "30.0" --e-prior "30.0" --dataset "Nottingham" --keys "major" --filter-train-set "True" --filter-val-set "True"
