...
do
    python search_states_filter_one_config.py --n-chords "2" --n-melody "0" --t-prior "230.0" --e-prior "225.0" --dataset "ABC Notation" --keys "phrygian" --filter-train-set "True" --filter-val-set "False"
