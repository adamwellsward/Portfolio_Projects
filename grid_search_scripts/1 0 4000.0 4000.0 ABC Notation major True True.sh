...
do
    python search_states_filter_one_config.py --n-chords "1" --n-melody "0" --t-prior "4000.0" --e-prior "4000.0" --dataset "ABC Notation" --keys "major" --filter-train-set "True" --filter-val-set "True"
