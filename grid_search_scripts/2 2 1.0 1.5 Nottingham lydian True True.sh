...
do
    python search_states_filter_one_config.py --n-chords "2" --n-melody "2" --t-prior "1.0" --e-prior "1.5" --dataset "Nottingham" --keys "lydian" --filter-train-set "True" --filter-val-set "True"
