...
do
    python search_states_filter_one_config.py --n-chords "2" --n-melody "1" --t-prior "0.0" --e-prior "0.0" --dataset "All" --keys "All" --filter-train-set "False" --filter-val-set "True"
