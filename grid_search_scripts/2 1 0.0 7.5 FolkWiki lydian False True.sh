...
do
    python search_states_filter_one_config.py --n-chords "2" --n-melody "1" --t-prior "0.0" --e-prior "7.5" --dataset "FolkWiki" --keys "lydian" --filter-train-set "False" --filter-val-set "True"
