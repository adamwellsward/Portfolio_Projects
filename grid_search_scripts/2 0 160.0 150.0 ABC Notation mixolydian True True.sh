...
do
    python search_states_filter_one_config.py --n-chords "2" --n-melody "0" --t-prior "160.0" --e-prior "150.0" --dataset "ABC Notation" --keys "mixolydian" --filter-train-set "True" --filter-val-set "True"
