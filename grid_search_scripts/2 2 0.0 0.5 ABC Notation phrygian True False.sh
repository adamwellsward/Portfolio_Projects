...
do
    python search_states_filter_one_config.py --n-chords "2" --n-melody "2" --t-prior "0.0" --e-prior "0.5" --dataset "ABC Notation" --keys "phrygian" --filter-train-set "True" --filter-val-set "False"
