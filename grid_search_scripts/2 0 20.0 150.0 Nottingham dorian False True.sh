...
do
    python search_states_filter_one_config.py --n-chords "2" --n-melody "0" --t-prior "20.0" --e-prior "150.0" --dataset "Nottingham" --keys "dorian" --filter-train-set "False" --filter-val-set "True"
