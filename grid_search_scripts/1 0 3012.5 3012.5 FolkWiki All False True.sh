...
do
    python search_states_filter_one_config.py --n-chords "1" --n-melody "0" --t-prior "3012.5" --e-prior "3012.5" --dataset "FolkWiki" --keys "All" --filter-train-set "False" --filter-val-set "True"
