...
do
    python search_states_filter_one_config.py --n-chords "2" --n-melody "1" --t-prior "0.0" --e-prior "5.0" --dataset "All" --keys "mixolydian" --filter-train-set "True" --filter-val-set "False"
