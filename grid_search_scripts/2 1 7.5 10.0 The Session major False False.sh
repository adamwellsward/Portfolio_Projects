...
do
    python search_states_filter_one_config.py --n-chords "2" --n-melody "1" --t-prior "7.5" --e-prior "10.0" --dataset "The Session" --keys "major" --filter-train-set "False" --filter-val-set "False"
