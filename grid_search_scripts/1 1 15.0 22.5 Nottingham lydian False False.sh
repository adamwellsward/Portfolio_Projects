...
do
    python search_states_filter_one_config.py --n-chords "1" --n-melody "1" --t-prior "15.0" --e-prior "22.5" --dataset "Nottingham" --keys "lydian" --filter-train-set "False" --filter-val-set "False"
