...
do
    python search_states_filter_one_config.py --n-chords "2" --n-melody "1" --t-prior "2.5" --e-prior "10.0" --dataset "ABC Notation" --keys "dorian" --filter-train-set "True" --filter-val-set "False"
