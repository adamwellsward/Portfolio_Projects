...
do
    python search_states_filter_one_config.py --n-chords "1" --n-melody "1" --t-prior "15.0" --e-prior "0.0" --dataset "All" --keys "major" --filter-train-set "True" --filter-val-set "False"
