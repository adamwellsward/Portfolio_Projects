...
do
    python search_states_filter_one_config.py --n-chords "1" --n-melody "1" --t-prior "7.5" --e-prior "15.0" --dataset "The Session" --keys "major" --filter-train-set "False" --filter-val-set "True"
