...
do
    python search_states_filter_one_config.py --n-chords "1" --n-melody "1" --t-prior "15.0" --e-prior "0.0" --dataset "JSB Chorales" --keys "All" --filter-train-set "False" --filter-val-set "True"
