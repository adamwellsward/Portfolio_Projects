...
do
    python search_states_filter_one_config.py --n-chords "2" --n-melody "2" --t-prior "0.5" --e-prior "2.0" --dataset "Nottingham" --keys "lydian" --filter-train-set "False" --filter-val-set "False"
