...
do
    python search_states_filter_one_config.py --n-chords "1" --n-melody "0" --t-prior "1037.5" --e-prior "3012.5" --dataset "ABC Notation" --keys "mixolydian" --filter-train-set "False" --filter-val-set "False"
