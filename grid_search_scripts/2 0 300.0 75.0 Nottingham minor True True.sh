...
do
    python search_states_filter_one_config.py --n-chords "2" --n-melody "0" --t-prior "300.0" --e-prior "75.0" --dataset "Nottingham" --keys "minor" --filter-train-set "True" --filter-val-set "True"
