...
do
    python search_states_filter_one_config.py --n-chords "2" --n-melody "2" --t-prior "1.5" --e-prior "2.0" --dataset "JSB Chorales" --keys "All" --filter-train-set "False" --filter-val-set "True"
