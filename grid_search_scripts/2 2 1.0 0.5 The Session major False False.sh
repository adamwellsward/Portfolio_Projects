...
do
    python search_states_filter_one_config.py --n-chords "2" --n-melody "2" --t-prior "1.0" --e-prior "0.5" --dataset "The Session" --keys "major" --filter-train-set "False" --filter-val-set "False"
