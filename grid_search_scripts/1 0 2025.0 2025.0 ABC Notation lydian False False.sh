...
do
    python search_states_filter_one_config.py --n-chords "1" --n-melody "0" --t-prior "2025.0" --e-prior "2025.0" --dataset "ABC Notation" --keys "lydian" --filter-train-set "False" --filter-val-set "False"
