...
do
    python search_states_filter_one_config.py --n-chords "1" --n-melody "1" --t-prior "30.0" --e-prior "22.5" --dataset "FolkWiki" --keys "dorian" --filter-train-set "False" --filter-val-set "True"
