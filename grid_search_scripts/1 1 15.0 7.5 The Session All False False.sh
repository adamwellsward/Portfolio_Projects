...
do
    python search_states_filter_one_config.py --n-chords "1" --n-melody "1" --t-prior "15.0" --e-prior "7.5" --dataset "The Session" --keys "All" --filter-train-set "False" --filter-val-set "False"
