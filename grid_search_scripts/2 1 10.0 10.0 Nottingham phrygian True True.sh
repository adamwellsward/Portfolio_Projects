...
do
    python search_states_filter_one_config.py --n-chords "2" --n-melody "1" --t-prior "10.0" --e-prior "10.0" --dataset "Nottingham" --keys "phrygian" --filter-train-set "True" --filter-val-set "True"
