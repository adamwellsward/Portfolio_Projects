...
do
    python search_states_filter_one_config.py --n-chords "2" --n-melody "2" --t-prior "1.5" --e-prior "1.5" --dataset "ABC Notation" --keys "lydian" --filter-train-set "False" --filter-val-set "False"
