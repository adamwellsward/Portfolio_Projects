...
do
    python search_states_filter_one_config.py --n-chords "1" --n-melody "0" --t-prior "4000.0" --e-prior "1037.5" --dataset "FolkWiki" --keys "dorian" --filter-train-set "False" --filter-val-set "False"
