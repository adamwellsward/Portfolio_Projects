...
do
    python search_states_filter_one_config.py --n-chords "2" --n-melody "2" --t-prior "1.0" --e-prior "2.0" --dataset "FolkWiki" --keys "major" --filter-train-set "True" --filter-val-set "True"
