...
do
    python search_states_filter_one_config.py --n-chords "2" --n-melody "1" --t-prior "7.5" --e-prior "7.5" --dataset "All" --keys "lydian" --filter-train-set "True" --filter-val-set "True"
