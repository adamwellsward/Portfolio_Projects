...
do
    python search_states_filter_one_config.py --n-chords "1" --n-melody "0" --t-prior "2025.0" --e-prior "1037.5" --dataset "The Session" --keys "dorian" --filter-train-set "True" --filter-val-set "True"
