...
do
    python search_states_filter_one_config.py --n-chords "2" --n-melody "0" --t-prior "20.0" --e-prior "300.0" --dataset "FolkWiki" --keys "phrygian" --filter-train-set "True" --filter-val-set "False"
