...
do
    python search_states_filter_one_config.py --n-chords "1" --n-melody "1" --t-prior "7.5" --e-prior "30.0" --dataset "ABC Notation" --keys "All" --filter-train-set "True" --filter-val-set "False"
