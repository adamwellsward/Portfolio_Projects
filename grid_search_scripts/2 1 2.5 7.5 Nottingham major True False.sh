...
do
    python search_states_filter_one_config.py --n-chords "2" --n-melody "1" --t-prior "2.5" --e-prior "7.5" --dataset "Nottingham" --keys "major" --filter-train-set "True" --filter-val-set "False"
