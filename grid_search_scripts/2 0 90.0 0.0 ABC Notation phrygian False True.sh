...
do
    python search_states_filter_one_config.py --n-chords "2" --n-melody "0" --t-prior "90.0" --e-prior "0.0" --dataset "ABC Notation" --keys "phrygian" --filter-train-set "False" --filter-val-set "True"
