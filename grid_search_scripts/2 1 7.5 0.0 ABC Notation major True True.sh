...
do
    python search_states_filter_one_config.py --n-chords "2" --n-melody "1" --t-prior "7.5" --e-prior "0.0" --dataset "ABC Notation" --keys "major" --filter-train-set "True" --filter-val-set "True"
